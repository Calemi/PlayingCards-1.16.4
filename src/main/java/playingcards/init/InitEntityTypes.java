...
import playingcards.entity.*;

public class InitEntityTypes {

    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = new DeferredRegister<>(ForgeRegistries.ENTITIES, PCReference.MOD_ID);
